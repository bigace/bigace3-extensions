 ...
 * @version $Id: function.link_editor.php 175 2011-03-25 14:27:34Z kevin $
...
{
	if(!isset($params['id'])) {
		trigger_error("link_editor: missing 'id' attribute");
		return;
	}	

	if(!isset($params['language'])) {
		trigger_error("link_editor: missing 'language' attribute");
		return;
	}	
