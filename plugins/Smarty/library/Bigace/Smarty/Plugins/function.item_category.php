 ...
 * @version $Id: function.item_category.php 175 2011-03-25 14:27:34Z kevin $
...
function smarty_function_item_category($params, &$smarty)
{
	if(!isset($params['id']) && !isset($params['item'])) {
		trigger_error("item_category: missing 'id' AND 'item' attribute");
		return;
	}

	if(!isset($params['assign'])) {
		trigger_error("item_category: missing 'assign' attribute");
		return;
	}
