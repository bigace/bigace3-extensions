 ...
 * @version $Id: function.modul.php 179 2011-03-28 08:16:57Z kevin $
...
function smarty_function_modul($params, &$smarty)
{
    ...
    if ($name == '') {
        trigger_error('modul: Empty name given. Do not use the {modul} tag for displaying content. Replace with {content}.');
        return $smarty->getTemplateVars('CONTENT');
    }
    ...
    trigger_error("modul: could not load modul '".$name."'.");
    return;
}
