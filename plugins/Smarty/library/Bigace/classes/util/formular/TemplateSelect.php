...
/**
 * This class defines a HTML Select Box for all installed Smarty Templates.
 ...
 * @version $Id: TemplateSelect.php 168 2011-03-25 09:47:28Z kevin $
 * @package bigace.classes
 * @subpackage util.formular
 */
class TemplateSelect extends Select
{
     ...
     * @var boolean
     */
    private $showDeactivated = false;
    /**
     * @var boolean
     */
    private $showSystemTemplates = false;
    /**
     * @var boolean
     */
    private $showPreselectIfDeactivated = true;
    /**
     * @var boolean
     */
    private $showIncludes = false;
    /**
     * @var boolean
     */
    private $sortAlpha = true;
